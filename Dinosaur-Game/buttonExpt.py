...
# Arduino setup
arduino = serial.Serial(port='/dev/cu.usbmodemC04E301141D82', baudrate=9600, timeout=1)  
...
while True:
    ...
    if arduino.in_waiting > 0:
        ...
        if line == "JUMP":
            dinosaur.jump()  # Trigger jump when Arduino sends "JUMP"

    # Pygame event handling and game loop
